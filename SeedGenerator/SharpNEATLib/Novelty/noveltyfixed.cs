...
namespace SharpNEATLib.Novelty
{
	...
	{	
		...
		public void add_most_novel(Population p)
		{
		    ...
		    archive.Add(best);
            using (System.IO.StreamWriter file = new System.IO.StreamWriter(@"C:\Users\Student\Google Drive\Research\Eplex\CreatureGarden\XNATest\XNATest\bin\x86\Debug\NoveltyLog.txt", true))
            {
                file.WriteLine("Fitness: " + best.Fitness);
                file.WriteLine("Behavior: " + best.Behavior.ToString());
            }
		}
